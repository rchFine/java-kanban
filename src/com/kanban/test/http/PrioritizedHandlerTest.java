...
public class PrioritizedHandlerTest {
    ...
    public void shouldReturnPrioritizedTasks() throws IOException, InterruptedException {
        Task task1 = new Task(0, "Task A", "First task", LocalDateTime.now().plusMinutes(10), Duration.ofMinutes(20));
        Task task2 = new Task(0, "Task B", "Second task", LocalDateTime.now().plusMinutes(31), Duration.ofMinutes(15));
        ...
        assertTrue(response.body().contains("Task B"));
    }
